package com.itau.myweixin;


import java.util.ArrayList;

import com.itau.jingdong.ui.SplashActivity;
...
//		startActivity(intent);	
		Toast.makeText(getApplicationContext(), "摇一摇", Toast.LENGTH_LONG).show();
	}
	public void penyou(View v) {                                   //�ֻ�ҡһҡ
		Toast.makeText(getApplicationContext(), "朋友圈", Toast.LENGTH_LONG).show();
		Intent intent = new Intent (MainWeixin.this,MimeWeiCircle.class);			
		startActivity(intent);	
	}
	public void open_shop(View v) {
		Toast.makeText(getApplicationContext(), "进入商场", Toast.LENGTH_LONG).show();
		Intent intent = new Intent (MainWeixin.this,SplashActivity.class);			
		startActivity(intent);	
	}
}
